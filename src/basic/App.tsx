...
const App = () => {
  ...
  const { updateQuantity, removeFromCart, addToCart, cart, setCart } =
    useCart();
  const { coupons, applyCoupon, addCoupon, deleteCoupon } = useCoupons(cart);
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <Header>
        <Header.Left>
          <Title as="h1" className="text-xl font-semibold text-gray-800">
            SHOP
          </Title>
