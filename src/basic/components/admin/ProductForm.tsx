        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
          ...
          <div>
            ...
            <input
              ...
              onBlur={(e) => validatePriceValue(e.target.value, (message) => addNotification(message, 'error'))}
              className="w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 px-3 py-2 border"
              placeholder="숫자만 입력"
              required
            />
          ...
          <div>
            ...
            <input
              ...
              onBlur={(e) => validateStockValue(e.target.value, (message) => addNotification(message, 'error'))}
              className="w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 px-3 py-2 border"
              placeholder="숫자만 입력"
              required
            />
