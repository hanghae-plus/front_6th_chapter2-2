...
interface AdminCouponFormProps {
  couponForm: FormState;
  setCouponForm: (s: FormState) => void;
  onSubmit: (e: React.FormEvent) => void;
  onCancel: () => void;
  addNotification: (msg: string, type?: 'error' | 'success' | 'warning') => void;
}

const AdminCouponForm: React.FC<AdminCouponFormProps> = ({ couponForm, setCouponForm, onSubmit, onCancel, addNotification }) => {
  return (
