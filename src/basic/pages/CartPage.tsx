...
type Props = {
  ...
  searchTerm: string;
  coupons: Coupon[];
  registerCart: ReturnType<typeof useCart>;
...
const CartPage = ({
  ...
  const { debouncedSearchTerm, searchResult } = useSearch(searchTerm, products);
  const { cart, addToCart, clearCart, removeFromCart, updateQuantity } =
    registerCart;
