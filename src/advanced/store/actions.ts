...
import { ProductWithUI, Coupon, Notification } from '../../types';
...
export const addNotificationAtom = atom(
  null,
  (_get, set, { message, type }: { message: string; type: 'success' | 'error' | 'warning' }) => {
...
export const completeOrderAtom = atom(null, (_get, set) => {
