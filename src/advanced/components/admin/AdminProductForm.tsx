...
const AdminProductForm = () => {
  ...
  // action atoms
  const handleSubmitAction = useSetAtom(handleProductFormSubmitAtom);
  const handleCancelAction = useSetAtom(handleCancelProductAtom);
  ...
  const updateProductForm = (updates: any) => {
    updateProductFormAction(updates);
  };
      ...
      <form onSubmit={onSubmit} className='space-y-4'>
        ...
        <div className='mt-4'>
          ...
          <div className='space-y-2'>
            {productForm.discounts.map((discount: any, index: number) => (
