...
export function CartItemList({ cart, onRemoveFromCart, onUpdateQuantity }: CartItemListProps) {
  if (cart.length === 0) {
    return (
      <div className='text-center py-8'>
        <Icon name='cartBagThin' width={64} height={64} className='text-gray-300 mx-auto mb-4' />
