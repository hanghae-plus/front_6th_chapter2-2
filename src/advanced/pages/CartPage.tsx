...
export function CartPage({
  ...
  const updateQuantity = useCallback(
    (productId: string, newQuantity: number) => {
      updateQuantityHook(productId, newQuantity, products, (message) => addNotification({ message, type: 'error' }));
    },
  ...
  const completeOrder = useCallback(() => {
    ...
    addNotification({ message: MESSAGES.ORDER.COMPLETED(orderNumber), type: 'success' });
    clearCart();
